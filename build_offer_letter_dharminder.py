"""Generate the Dharminder Singh offer letter on the Crownest letterhead,
...
OUTPUT = "Offer_Letter_Dharminder_Singh.pdf"
...
story = []
story.append(Paragraph("<b>Date:</b> 10 August 2026", plain))
story.append(Spacer(1, 10))
story.append(Paragraph("<b>To,</b>", plain))
story.append(Paragraph("<b>Dharminder Singh</b>", plain))
story.append(Paragraph("H. No. 331, Block-25, Near Sant Nirankari Bhawan, Trilokpuri, Delhi - 110091", plain))
story.append(Spacer(1, 12))
story.append(Paragraph("Subject: Offer of Employment", subj))
story.append(Paragraph("Dear Dharminder,", body))
story.append(Paragraph(
    "We are pleased to offer you the position of <b>Zonal Maintenance Head</b> at "
...
story.append(Paragraph(
    f'<font color="{GOLD}">&bull;</font>&nbsp;&nbsp;<b>Designation:</b> Zonal Maintenance Head', hang))
story.append(Paragraph(
    f'<font color="{GOLD}">&bull;</font>&nbsp;&nbsp;<b>Compensation:</b> Your salary will be '
    'Rs. 35,000 subject to standard statutory deductions.', hang))
...
story.append(Paragraph(
    "<b>Accepted &amp; agreed</b> (Dharminder Singh) &nbsp;—&nbsp; "
